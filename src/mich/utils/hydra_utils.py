"""A collection of miscellaneous functions useful for the lighting/hydra
template."""
...
def reload_original_config(
    ...
    ckpt_flag: str = "*best*.ckpt",
    set_wandb_resume: bool = True,
    reload_states: bool = False,
    ...
    # Load the original config found in the the file directories
...
def log_hyperparameters(cfg: DictConfig, model: LightningModule, trainer: Trainer) -> None:
    ...
    hparams["model/params/total"] = sum(p.numel() for p in model.parameters())  # type: ignore
